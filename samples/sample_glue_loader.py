...
NEO4J_ENDPOINT = 'bolt://<your-Amundsen-Host-IP-here>:7687'
NEO4j_USERNAME = 'neo4j'
NEO4j_PASSWORD = 'test'
GLUE_CLUSTER_KEY = '<your-AWS-Account-ID>'

os.environ['AWS_PROFILE'] = "default"
os.environ['AWS_DEFAULT_REGION'] = "<region-where-the-Glue-crawler-was-created>"

es = Elasticsearch([
    {'host': '<your-Amundsen-Host-IP-here>', 'port': 9200}, 
])
